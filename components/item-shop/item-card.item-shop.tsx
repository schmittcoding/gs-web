...
function ItemCard({ item }: ItemCardProps) {
  ...
  return (
    <>
      <Card
        className={cn(
          "group/item shape-main cursor-pointer aspect-auto md:aspect-square item-card",
          "transition-all duration-300 ease-out hover:shadow-lg hover:shadow-black/30",
      ...
      >
        ...
        {tag && (
          <div
            className={cn(
              ...
              "group-data-[variant='primary']:bg-primary group-data-[variant='primary']:text-primary-foreground",
              "group-data-[variant='destructive']:bg-destructive group-data-[variant='destructive']:text-white",
              "group-data-[variant='accent']:bg-accent group-data-[variant='accent']:text-background",
            )}
            data-slot="item-tag"
          >
        ...
        <CardContent className="size-full flex flex-col justify-between">
        ...
        <section className="px-4 pb-2 md:pb-4 flex items-center justify-between">
          <Coin
