...
export default function ProfileDetails({ user }: ProfileDetailsProps) {
  ...
  return (
    <Card className="h-max w-full" variant="accent">
      ...
      <Separator />
      <CardContent className="py-4 grid grid-cols-2 gap-2 lg:grid-cols-1">
        <Coin size="lg" value={user.web_points} />
        <Coin variant="mcoin" size="lg" value={user.mileage_points} />
      </CardContent>
      <Separator />
      <CardFooter className="py-4 grid grid-cols-2 gap-2 lg:grid-cols-1">
